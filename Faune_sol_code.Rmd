...
poiss_plot <- ggplot(faune_sol,aes(x=Traitement,y=log(Abondance+1),fill=Traitement))+
  ...
  geom_signif(comparisons=list(c("Ligneux", "Non_ligneux")), annotations="*", y_position = 5, tip_length = 0, vjust=0)+
...
ligneux_rare <- iNEXT(mat_ligneux, q=c(0,1,2), datatype = "abundance")
